...
@Setter
@ToString
public class RrRestaurantCar extends RailroadCar {
    ...
    public RrRestaurantCar(double grossWeight, String source) {
    ...
    public void printInfo() {
        System.out.println("Railroad restaurant Car information:");
    ...
    @Override
    public void honk() {
        System.out.println("NIIIIIIIIIIII");
    }

    @Override
    public void siren() {
        System.out.println("DADADADADDADADAD");
    }
